...
```json
{
  ...
  "instrumental": false,
  "model": "V4_5ALL",
  "callBackUrl": "https://YOUR_DOMAIN.com/api/webhook"
}
```
...
The API requires a `callBackUrl` parameter. We use `https://YOUR_DOMAIN.com/api/webhook` as a placeholder since our implementation uses polling instead of webhooks.
