...
- Tier: Basic ($100/mo — 10K reads, 3K writes, search, timelines)
...
## Listener (Automated Engagement)

**Script:** `skills/twitter/listener.py`
**Cron:** Every 30 minutes via system crontab
